...
Inclui verificação de webhook e informações detalhadas do bot.
"""
import os
import logging
import asyncio
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('telegram_connection_test_v3.log')
    ]
)
    ...
    try:
        async with aiohttp.ClientSession() as session:
            ...
            async with session.get(url) as response:
                ...
                logger.info("Informações do Webhook:")
                ...
                if data.get('result', {}).get('url'):
                    logger.warning("ATENÇÃO: Há um webhook configurado. Isso pode estar interferindo no modo polling.")
...
async def test_telegram_connection() -> None:
    ...
    try:
        ...
        logger.info("Verificando webhooks configurados...")
