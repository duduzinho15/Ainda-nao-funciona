...
class Metrics:
    ...
    def __init__(self, total_ofertas: int = 0, lojas_ativas: int = 0, preco_medio: float = 0.0):
...
class MetricsCollector:
    ...
    def _export_csv(self) -> str:
        ...
        for metric in self.metrics_history:
            csv_lines.append(f"{metric.timestamp.isoformat()},{metric.total_ofertas},{metric.lojas_ativas},{metric.preco_medio}\n")
