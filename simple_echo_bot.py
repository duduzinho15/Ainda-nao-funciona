...
logging.basicConfig(
    ...
    level=logging.INFO,
    handlers=[logging.StreamHandler(), logging.FileHandler("echo_bot.log")],
)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        f"Olá {user.first_name}! Eu sou um bot de eco. Envie-me uma mensagem e eu a repetirei para você."
    )
