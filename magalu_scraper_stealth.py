"""
Scraper Stealth para o Magazine Luiza - Usando Playwright com técnicas anti-detecção
"""
import asyncio
import time
import logging
...
class MagazineLuizaStealthScraper:
    """Scraper stealth para o Magazine Luiza usando Playwright"""
    ...
    async def buscar_ofertas(self, max_paginas: int = 3) -> List[Dict]:
        """Busca ofertas do Magazine Luiza de forma stealth"""
        ofertas = []
...
async def main():
    ...
    scraper = MagazineLuizaStealthScraper(headless=False)  # False para debug
