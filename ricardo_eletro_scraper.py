#!/usr/bin/env python3
"""
Scraper para Ricardo Eletro - Coleta ofertas e promoções
"""
...
class RicardoEletroScraper:
    """Scraper para Ricardo Eletro usando aiohttp"""

    def __init__(self):
        self.base_url = "https://www.ricardoeletro.com.br"
        self.ofertas_url = "https://www.ricardoeletro.com.br/ofertas"
        self.headers = {
    ...
    async def buscar_ofertas(self, max_paginas: int = 2) -> List[Dict[str, Any]]:
        """
        Busca ofertas na Ricardo Eletro
        ...
        try:
            logger.info("🔍 Iniciando busca de ofertas na Ricardo Eletro")
    ...
    def _extrair_dados_produto(self, produto) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            titulo = titulo_elem.get_text(strip=True) if titulo_elem else "Produto Ricardo Eletro"
            ...
            if not titulo or titulo == "Produto Ricardo Eletro":
                return None
...
async def buscar_ofertas_ricardo_eletro(max_paginas: int = 2) -> List[Dict[str, Any]]:
    """
    Função principal para buscar ofertas na Ricardo Eletro
...
async def get_ofertas(periodo: str = "24h") -> List[Dict[str, Any]]:
    ...
    """
    try:
        # Buscar ofertas da Ricardo Eletro
        ofertas = await buscar_ofertas_ricardo_eletro(max_paginas=2)
        
        # Adicionar metadados
        for oferta in ofertas:
            oferta['fonte'] = 'ricardo_eletro_scraper'
...
priority = 75  # Prioridade alta
rate_limit = 0.5  # 0.5 requisições por segundo
description = "Scraper para Ricardo Eletro - Ofertas e promoções"


# Teste direto
if __name__ == "__main__":
    async def main():
        print("🔍 Testando scraper da Ricardo Eletro...")
        print("=" * 60)
        
        try:
            ofertas = await buscar_ofertas_ricardo_eletro(max_paginas=1)
