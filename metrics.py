...
OFFERS_DUPLICATED = Counter(
    "gg_offers_duplicated_total", "Ofertas duplicadas detectadas"
)
SCRAPER_ERRORS = Counter(
    "gg_scraper_errors_total", "Erros de scrapers", ["scraper_name"]
)
SCRAPER_SUCCESS = Counter(
    "gg_scraper_success_total", "Sucessos de scrapers", ["scraper_name"]
)
