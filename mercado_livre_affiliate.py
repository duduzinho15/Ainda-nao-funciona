...
class MercadoLivreAffiliate:
    ...
    def generate_affiliate_url(
        self, original_url: str, product_info: Optional[Dict[str, Any]] = None
    ) -> str:
        """
        ...
        try:
            ...
            if url_info["type"] == "produto":
                return self._generate_product_affiliate_url(
                    clean_url, url_info, product_info
                )
    ...
    def _extract_url_info(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if "produto" in path_parts or any(
                re.match(r"MLB-\d+", p) for p in path_parts
            ):
    ...
    def _generate_product_affiliate_url(
        self,
        clean_url: str,
    ...
    def _generate_category_affiliate_url(
        self, clean_url: str, url_info: Dict[str, Any]
    ) -> str:
    ...
    def _generate_search_affiliate_url(
        self, clean_url: str, url_info: Dict[str, Any]
    ) -> str:
    ...
    def _generate_short_affiliate_url(
        self, url_info: Dict[str, Any], product_info: Optional[Dict[str, Any]]
    ) -> Optional[str]:
