#!/usr/bin/env python3
"""
Scraper para Casas Bahia - Coleta ofertas e promoções
"""
...
class CasasBahiaScraper:
    """Scraper para Casas Bahia usando aiohttp"""

    def __init__(self):
        self.base_url = "https://www.casasbahia.com.br"
        self.ofertas_url = "https://www.casasbahia.com.br/ofertas"
        self.headers = {
    ...
    async def buscar_ofertas(self, max_paginas: int = 2) -> List[Dict[str, Any]]:
        ...
        try:
            logger.info("🔍 Iniciando busca de ofertas na Casas Bahia")
    ...
    def _extrair_ofertas_da_pagina(self, html: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            produtos = soup.find_all('div', class_=re.compile(r'product|item|card'))
    ...
    def _extrair_dados_produto(self, produto) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            titulo = titulo_elem.get_text(strip=True) if titulo_elem else "Produto Casas Bahia"
            ...
            if not titulo or titulo == "Produto Casas Bahia":
                return None
...
async def buscar_ofertas_casas_bahia(max_paginas: int = 2) -> List[Dict[str, Any]]:
    """
    Função principal para buscar ofertas na Casas Bahia
...
async def get_ofertas(periodo: str = "24h") -> List[Dict[str, Any]]:
    ...
    """
    try:
        # Buscar ofertas da Casas Bahia
        ofertas = await buscar_ofertas_casas_bahia(max_paginas=2)
        
        # Adicionar metadados
        for oferta in ofertas:
            oferta['fonte'] = 'casas_bahia_scraper'
...
priority = 85  # Prioridade alta
rate_limit = 0.5  # 0.5 requisições por segundo
description = "Scraper para Casas Bahia - Ofertas e promoções"


# Teste direto
if __name__ == "__main__":
    async def main():
        print("🔍 Testando scraper da Casas Bahia...")
        print("=" * 60)
        
        try:
            ofertas = await buscar_ofertas_casas_bahia(max_paginas=1)
