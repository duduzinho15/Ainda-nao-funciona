#!/usr/bin/env python3
"""
Scraper para Ponto Frio - Coleta ofertas e promoções
"""
...
class PontoFrioScraper:
    """Scraper para Ponto Frio usando aiohttp"""

    def __init__(self):
        self.base_url = "https://www.pontofrio.com.br"
        self.ofertas_url = "https://www.pontofrio.com.br/ofertas"
        self.headers = {
    ...
    async def buscar_ofertas(self, max_paginas: int = 2) -> List[Dict[str, Any]]:
        ...
        try:
            logger.info("🔍 Iniciando busca de ofertas no Ponto Frio")
    ...
    def _extrair_dados_produto(self, produto) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            titulo = titulo_elem.get_text(strip=True) if titulo_elem else "Produto Ponto Frio"
            ...
            if not titulo or titulo == "Produto Ponto Frio":
                return None
...
async def buscar_ofertas_ponto_frio(max_paginas: int = 2) -> List[Dict[str, Any]]:
    """
    Função principal para buscar ofertas no Ponto Frio
...
async def get_ofertas(periodo: str = "24h") -> List[Dict[str, Any]]:
    ...
    """
    try:
        # Buscar ofertas do Ponto Frio
        ofertas = await buscar_ofertas_ponto_frio(max_paginas=2)
        
        # Adicionar metadados
        for oferta in ofertas:
            oferta['fonte'] = 'ponto_frio_scraper'
...
priority = 70  # Prioridade alta
rate_limit = 0.5  # 0.5 requisições por segundo
description = "Scraper para Ponto Frio - Ofertas e promoções"


# Teste direto
if __name__ == "__main__":
    async def main():
        print("🔍 Testando scraper do Ponto Frio...")
        print("=" * 60)
        
        try:
            ofertas = await buscar_ofertas_ponto_frio(max_paginas=1)
